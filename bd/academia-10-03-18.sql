...
--
-- Host: 127.0.0.1
-- Generation Time: 11-Mar-2018 às 00:24
...
CREATE TABLE `historicos_mensalidades` (
  ...
  `status_historico` varchar(50) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `mensalidades` (`idmensalidades`, `idalunos_cliente`, `idplano`, `data_mens_pag`, `status_mensalidades`) VALUES
(1, 1, 1, '2018-03-10', 'PAGO');
...
CREATE TABLE `planos` (
  ...
  `tipo_plano` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
...
(1, 'Semanal - a cada 7 dias ', '7 dias', '10.00');
...
ALTER TABLE `historicos_mensalidades`
  ...
  ADD KEY `mensalidade_idx` (`idmensalidade`);
...
--
ALTER TABLE `itens_vendas`
  MODIFY `iditensvendas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `mensalidades`
--
ALTER TABLE `mensalidades`
  MODIFY `idmensalidades` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `historicos_mensalidades`
  ADD CONSTRAINT `mensalidade` FOREIGN KEY (`idmensalidade`) REFERENCES `mensalidades` (`idmensalidades`) ON DELETE NO ACTION ON UPDATE NO ACTION;
