...
<div class="container">
    ...
    <div id="fundo" class="well">
        <div class="col-md-12">
            ...
            <button type="button" class="btn btn-primary"id="novo-treino"><i class="glyphicon glyphicon-plus"></i> Novo Treino</button>
            <button type="button" class="btn btn-danger" id="fechar-treino"><i class="glyphicon glyphicon-remove"></i> Fechar Treino</button>
            <a href="http://localhost/AcademiaPerformanceFit/5/Views/view.treinos.relatorio.php" target="_blank"><button class="btn btn-warning"><i class="glyphicon glyphicon-print"></i> Relatório</button></a>
        </div>

        <div class="alert alert-success">Cadastro Realizado com sucesso!</div>

        <!--FORMULÁRIO DE CADASTRO DE TREINOS-->
        <div class="col-md-12 treino-div">
        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                foreach ($ReadTreinos->getResult() as $e):
                    ...
                    " <a href='http://localhost/AcademiaPerformanceFit/5/Views/view.treino.relatorio.php' target='_blank'><button id='imprimir' class='btn btn-warning btn-xs'><i class='glyphicon glyphicon-print'></i></button></a>" .
