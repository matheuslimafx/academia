    ...
    <div id="fundo" class="well">
        <div class="col-md-12">
           <form action="" method="POST">
            ...
            <button class="btn btn-primary" id="novo-funcionario"><i class="glyphicon glyphicon-user"></i> Novo Funcionário</button>
            <button class="btn btn-danger" id="fechar-funcionario"><i class="glyphicon glyphicon-remove"></i> Fechar Formulário</button>
            <a href="http://localhost/AcademiaPerformanceFit/5/Views/view.funcionarios.relatorio.php" target="_blank"><button class="btn btn-warning"><i class="glyphicon glyphicon-print"></i> Relátorio</button></a>
        </div>
        ...
        <div class="col-md-12 funcionario-div">
            ...
            <tbody>
                ...
                foreach ($ReadFun->getResult() as $e):
                    ...
                    "<td>".
                        ...
                        " <a href='http://localhost/AcademiaPerformanceFit/5/Views/view.funcionario.relatorio.php' target='_blank'><button id='imprimir' class='btn btn-warning btn-xs'><i class='glyphicon glyphicon-print'></i></button></a>" .
                    "</td>" .
                    "</tr>";
                endforeach;
                ?>
