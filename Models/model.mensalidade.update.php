...
/**
 * <b>Update.class:</b>
 * Model(Classe) responsável por atualizações de Mensalidades no banco de dados!
 */
class AtualizarMensalidade {
    ...
    /**
     * <b>atualizarMensalidade:</b> Executa uma atualização simplificada com Prepared Statments. Basta informar o 
     ...
     */
    public function atualizarMensalidade($Tabela, array $Dados, $Termos, $ParseString) {
