...
/**
 * <b>Update.class:</b>
 * Model(Classe) responsável por atualizações do estoque no banco de dados
 */
class AtualizarEstoque {
    ...
    /**
     * <b>atualizarEstoque:</b> Executa uma atualização simplificada com Prepared Statments. Basta informar o 
     ...
     */
    public function atualizarEstoque($Tabela, array $Dados, $Termos, $ParseString) {
