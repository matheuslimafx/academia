...
/**
 * <b>Update.class:</b>
 * Model(Classe) responsável por atualizações de Treinos no banco de dados!
 */
class AtualizarTreino {
    ...
    /**
     * <b>atualizarTreino:</b> Executa uma atualização simplificada com Prepared Statments. Basta informar o 
     ...
     */
    public function atualizarTreino($Tabela, array $Dados, $Termos, $ParseString) {
