...
/**
 * <b>Update.class:</b>
 * Model(Classe) responsável por atualizações de alunos no banco de dados!
 */
class AtualizarFornecedor {
    ...
    /**
     * <b>atualizarAluno:</b> Executa uma atualização simplificada com Prepared Statments. Basta informar o 
     ...
     */
    public function atualizarFornecedor($Tabela, array $Dados, $Termos, $ParseString) {
    ...
    /**
     * <b>atualizarEnderecoAluno:</b> Executa uma atualização simplificada com Prepared Statments. Basta informar o 
     * nome da tabela, os dados a serem atualizados em um Array Atribuitivo, as condições e uma 
     * analize em cadeia (ParseString) para executar.
     * @param STRING $Tabela = Nome da tabela
     * @param ARRAY $Dados = [ NomeDaColuna ] => Valor ( Atribuição )
     ...
     * @param STRING $ParseString = link={$link}&link2={$link2}
     */
    public function atualizarEnderecoForn($Tabela, array $Dados, $Termos, $ParseString) {
        $this->Tabela = (string) $Tabela;
        $this->Dados = $Dados;
        $this->Termos = (string) $Termos;
